            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center">
                <div className="w-full sm:w-auto md:w-96 text-black-600 space-y-5 p-4 shadow-xl border rounded-xl bg-[#fff9f9]">
                    <div className="text-center">
                        <div className="mt-2">
                            <h3 className="text-black-800 text-xl font-semibold sm:text-2xl">Welcome Back</h3>
                        </div>
                    </div>
                    <form
                        onSubmit={onSubmit}
                    ...
                    >
                        ...
                        {errorMessage && (
                            <span className='text-red-600 text-sm flex justify-center items-center h-full'>{errorMessage}</span>
                        )}
